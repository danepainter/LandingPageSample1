              ...
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className="text-sm hover:text-accent-400 transition-colors focus:outline-none focus:text-accent-400"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  ...
                  className="hover:text-accent-400 transition-colors focus:outline-none focus:text-accent-400"
                >
              ...
              <li className="pt-2">{companyProfile.hours}</li>
            </ul>
          </div>
